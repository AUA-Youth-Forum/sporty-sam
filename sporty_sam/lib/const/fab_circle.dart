...
class FabCircle extends StatefulWidget {
  ...
  @override
  FabCircleState createState() => FabCircleState();
}

class FabCircleState extends State<FabCircle>
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: RawMaterialButton(
              ...
              child: Center(
                  child: Text("Covid Mode", textAlign: TextAlign.center, style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold, fontSize: 20),)),
            ),
          ),
        ],
      ),
  ...
  Widget _applyTransformations(Widget child, int index) {
    ...
    final angle =
        vector.radians(360.0 / (widget.children.length) * index + angleFix);
  ...
  void _calculateProps() {
    ...
    _ringDiameter =
        widget.ringDiameter ?? min(_screenWidth, _screenHeight);
